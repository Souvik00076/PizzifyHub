...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/cart/update-cart', pizza).then(function (res) {
...
var inputEl = document.querySelector('#hidden_input');
var order = inputEl ? inputEl.value : null;
var time = document.createElement('small');
order = JSON.parse(order);
var update = function update(order) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkreal_time_pizza_backend"] = self["webpackChunkreal_time_pizza_backend"] || [];
